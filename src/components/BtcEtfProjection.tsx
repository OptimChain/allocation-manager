    ...
    return (
      <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
        <div className="flex items-center gap-2 mb-2">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">BTC ETF Projection</h3>
        </div>
    ...
    <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md transition-shadow">
      ...
      <div className="grid grid-cols-2 gap-6 mb-4">
        <div>
          ...
          <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{formatCurrency(etfQuote.close)}</p>
